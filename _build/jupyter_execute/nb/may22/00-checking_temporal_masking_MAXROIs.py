...
raw_data_file = (f"/home/joyneelm/approach-retreat/near_miss_analysis/classification_data"
                 f"/MAX_rois_122subjs_full_segments_withshock_hemodynamic_lag{hemo_lag}.pkl")
...
model_file = f"{results_dir}/emoprox_full_data/models/GRU_classifier_hemolag{hemo_lag}_MAX_mask{MASK}"
history_file = f"{results_dir}/emoprox_full_data/models/GRU_classifier_hemolag{hemo_lag}_MAX_mask{MASK}_history"
...
# GRU model does not cross 63% accuracy. This shows that MAX rois dataset has something wrong in it.
# 
...
# The accuracies on MAX ROIs dataset are around 60%.
# Neither MASK nor custom loss affect performance!!
