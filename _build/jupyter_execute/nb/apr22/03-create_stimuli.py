...
def get_subj_tr_dfs(subj, run_list):
    ...
    for run in run_list:
        ...
        # finally censor with shock
        df_tr['shock_censor'] = np.ones_like(df_tr['shock_time_conv'])
        df_tr['shock_censor'][df_tr['shock_time_conv'] > 0] = 0.0
        df_tr[df_tr['shock_time_conv'] > 0] = np.nan
