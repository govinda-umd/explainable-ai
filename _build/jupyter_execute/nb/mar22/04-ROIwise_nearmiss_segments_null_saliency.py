...
### adversarial-regularized modeladv_model_file = f"{results_dir}/models/GRU_classifier_adv_model"
...
adv_model.summary()adv_model.trainable = False
...
#     show_shapes=True)MAX85 = image.load_img(img=f"/home/govindas/parcellations/MAX_85_ROI_masks/MAX_ROIs_final_gm_85.nii.gz")
